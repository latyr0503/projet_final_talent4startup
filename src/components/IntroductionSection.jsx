      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-6">
        <div className="flex flex-col lg:flex-row items-start justify-between w-full max-w-5xl">
          <div className="flex-1 mb-8 lg:mb-0 lg:mr-8">
            <h1 className="text-5xl font-bold mb-6">Soins et équipements</h1>
            <h1 className="text-5xl  mb-6">
              de qualité pour les <br />
              patients
            </h1>
            ...
            <div className="flex justify-start ">
              <Link to="/about">
                <button className="bg-green-300 text-white px-4 py-2 rounded-full flex items-center gap-2 hover:bg-green-600 transition-transform transform hover:translate-y-1">
